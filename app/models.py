...
class QuestionBank(Base):
    ...
    text: Mapped[str]                                       # enonce de la question
    num_choices: Mapped[int]                                # nombre de choix (2 a 6)
    ...
    category: Mapped[str | None] = mapped_column(default=None)  # tag libre (ex: "Azure", "Linux")
